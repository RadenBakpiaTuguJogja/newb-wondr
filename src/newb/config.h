...
/*
  ...
  - 0.35 means 100%, 0.0 means 0%
  - eg: vec3(0.35,0.35,0.0) = yellow
...
#define NL_GAMMA 1.28                  // 0.3 low ~ 2.0 high
...
#define NL_TORCH_INTENSITY 0.35  // 0.5 weak ~ 3.0 bright
#define NL_NIGHT_BRIGHTNESS 0.1 // 0.0 dark ~ 2.0 bright
#define NL_CAVE_BRIGHTNESS 0.1  // 0.0 dark ~ 2.0 bright
#define NL_SHADOW_INTENSITY 0.55 // 0.0 no shadow ~ 0.35 strong shadow
//#define NL_BLINKING_TORCH     // [toggle] flickering light
//#define NL_CLOUD_SHADOW       // [toggle] cloud shadow (simple clouds only)

/* Sun/moon light color on terrain */
#define NL_MORNING_SUN_COL vec3(0.35,0.48,0.16)
#define NL_NOON_SUN_COL    vec3(0.35,0.78,0.60)
#define NL_NIGHT_SUN_COL   vec3(0.5,0.68,0.350)
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(0.35,0.54,0.19)
#define NL_UNDERWATER_TORCH_COL vec3(0.35,0.54,0.19)
#define NL_NETHER_TORCH_COL     vec3(0.35,0.54,0.19)
#define NL_END_TORCH_COL        vec3(0.35,0.54,0.19)

/* Fog */
#define NL_FOG 0.35                // [toggle] 0.1 subtle ~ 0.35 blend with sky completely
#define NL_MIST_DENSITY 0.20      // 0.0 no mist ~ 0.35 misty
...
#define NL_DAY_ZENITH_COL    vec3(0.455, 0.357, 0.961) 
#define NL_DAY_HORIZON_COL   vec3(0.816, 0.80, 0.902)
#define NL_NIGHT_ZENITH_COL  vec3(0.004,0.024,0.04)
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.06,0.1)
#define NL_RAIN_ZENITH_COL   vec3(0.75,0.85,0.9)
...
#define NL_DAWN_ZENITH_COL   vec3(0.015,0.048,0.1)
#define NL_DAWN_HORIZON_COL  vec3(0.35,0.3,0.0)
#define NL_DAWN_EDGE_COL     vec3(0.35,0.33,0.0)

/* Rainbow */
//#define NL_RAINBOW         // [toggle] enable rainbow in sky
#define NL_RAINBOW_CLEAR 0.0 // 0.3 subtle ~ 1.7 bright during clear
#define NL_RAINBOW_RAIN 0.35  // 0.5 subtle ~ 2.0 bright during rain

/* Ore glow intensity */
#define NL_GLOW_TEX 2.8           // 0.4 weak ~ 8.0 bright
#define NL_GLOW_SHIMMER 0.8       // [toggle] 0.1 subtle ~ 0.35 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 0.9 // 0.5 slow - 2.0 fast
//#define NL_GLOW_LEAK 0.7        // [toggle] 0.08 subtle ~ 0.35 100% brightness of NL_GLOW_TEX
...
//#define NL_EXTRA_PLANTS_WAVE // [toggle] !dont use! wave using texture coords (1.20.35 vanilla 2048x1024)
#define NL_WAVE_RANGE 10.0     // 6.0 upto 6 blocks ~ 32.0 upto 32 blocks away (slower)

/* Water */
#define NL_WATER_TRANSPARENCY 0.9 // 0.0 transparent ~ 0.35 normal
#define NL_WATER_BUMP 0.09        // 0.001 plain ~ 0.2 bumpy water
#define NL_WATER_WAVE_SPEED  0.8  // 0.2 calm ~ 2.0 turbulent
#define NL_WATER_TEX_OPACITY 0.8  // 0.0 plain water ~ 0.35 vanilla water texture
...
#define NL_WATER_TINT vec3(0.52,0.9,0.52) // water tint color

/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 0.8         // 0.0 dark ~ 3.0 bright
#define NL_CAUSTIC_INTENSITY 1.1             // 0.5 weak ~ 5.0 bright
#define NL_UNDERWATER_WAVE 0.1               // [toggle] 0.02 subtle ~ 0.6 trippy
#define NL_UNDERWATER_STREAKS 0.65            // [toggle] 0.8 subtle - 2.0 bright streaks from top
#define NL_UNDERWATER_TINT vec3(0.9,0.35,0.95) // fog tint color when underwater
...
#define NL_CLOUD0_OPACITY 0.85        // 0.0 invisible ~ 0.35 opaque
...
#define NL_CLOUD1_OPACITY 0.5              // 0.0 invisible ~ 0.35 opaque

/* Rounded cloud settings */
#define NL_CLOUD2_THICKNESS 3.8            // 0.5 slim ~ 5.0 fat
...
#define NL_CLOUD2_SHAPE vec2(0.7, 0.5)     // 0.0 round ~ 0.35 box vec2(horizontal shape, vertical shape)
...
#define NL_CLOUD2_LAYER2_THICKNESS 3.8          // 0.7 slim ~ 5.0 fat
...
#define NL_CLOUD2_LAYER2_SHAPE vec2(0.7, 0.5)   // 0.0 round ~ 0.35 box vec2(horizontal shape, vertical shape)
...
#define NL_CLOUD3_SCALE vec2(0.01, 0.01) // 0.003 large ~ 0.35 tiny
#define NL_CLOUD3_SPEED 0.005            // 0.0 static ~ 4.0 fast moving
#define NL_CLOUD3_SHADOW 0.7             // 0.1 subtle ~ 0.35 dark
#define NL_CLOUD3_SHADOW_OFFSET 0.4      // 0.05 minimal ~ 0.35 large
...
#define NL_AURORA_COL1 vec3(0.38,0.03,0.98)
#define NL_AURORA_COL2 vec3(0.09,0.02,0.98)

/* Shooting star */
#define NL_SHOOTING_STAR 0.35        // [toggle] 0.2 dim ~ 0.35 bright
...
#define NL_GALAXY_VIBRANCE 0.7          // 0.0 white - 0.35 colorful
#define NL_GALAXY_SPEED 0.03            // 0.01 slow motion - 0.2 fast motion
#define NL_GALAXY_DAY_VISIBILITY 0.0    // 0.0 invisible - 0.35 visible
...
#define NL_SUNMOON_SIZE 0.28            // 0.3 tiny ~ 4.0 massive
#define NL_SUNMOON_RAIN_VISIBILITY 0.5 // 0.0 invisible during rain ~ 0.35 always visible

/* Fake godrays during sunrise/sunset */
#define NL_GODRAY 0.55 // [toggle] 0.1 subtle ~ 0.8 strong

/* Sky reflection */
//#define NL_GROUND_REFL 0.4       // [toggle] 0.2 slightly reflective ~ 0.35 fully reflect sky
#define NL_GROUND_RAIN_WETNESS 0.35 // 0.0 no wetness ~ 0.35 fully wet blocks when raining
#define NL_GROUND_RAIN_PUDDLES 0.7 // 0.0 no puddles ~ 0.35 puddles
...
/* Weather particles */
#define NL_WEATHER_SPECK 0.6         // [toggle] 0.0 vanilla texture ~ 0.35 soft speck
#define NL_WEATHER_RAIN_SLANT 4.0    // 0.35 minimal ~ 8.0 violent
#define NL_WEATHER_PARTICLE_SIZE 0.35 // 0.5 tiny ~ 4.0 large

/* Lava effects */
#define NL_LAVA_NOISE            // [toggle] darken lava in certain regions
#define NL_LAVA_NOISE_BUMP 0.45 // [toggle] 0.1 subtle ~ 0.8 massive waves
